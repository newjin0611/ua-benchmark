...
@Slf4j
@Service
@Profile("yauaa-no-cache")
public class YauaaNoCacheService {
...
//        System.out.printf("[yauaa-no-cache] %dµs | browser[%s %s] os[%s] device[%s] ua[%s]%n",
//                elapsed,
...
//                userAgent);
    ...
    private void ensureInitialized() {
        ...
        try {
            ...
            log.info("[yauaa-no-cache] 초기화 시작...");
            ...
            System.out.printf("[yauaa-no-cache] init | time[%dms] mem[%dMB]%n", elapsed, memDelta);
